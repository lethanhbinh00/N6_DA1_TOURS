            ...
            <div class="col-md-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="keyword" class="form-control border-start-0" 
                           placeholder="Mã BK, Tên, SĐT, CCCD..." 
                    ...
                    <?php if (!empty($bookings)): ?>
                        ...
                        <tr class="<?= $isZeroPrice ? 'bg-danger bg-opacity-10' : '' ?>">
                            ...
                            <td class="text-start">
                                ...
                                <div class="fw-bold text-truncate my-1" style="max-width: 150px;" title="<?= htmlspecialchars($bk['tour_name'] ?? '') ?>">
                            ...
                            <td class="text-start">
                                <?php 
                                    ...
                                    elseif($percent > 0) $progressColor = 'bg-warning';
                                ?>
                                ...
                                <?php if($total > 0): ?>
                                    ...
                                    <?php if($remain <= 0): ?>
                                        <div class="text-success small fw-bold text-end">
                                            <i class="fas fa-check-circle me-1"></i> Đã thanh toán đủ
                                        </div>
                                    <?php else: ?>
                                        <div class="d-flex justify-content-between small text-muted">
                                            <span>Đã trả:</span>
                                            <span class="<?= ($deposit > 0) ? 'text-dark fw-bold' : '' ?>"><?= number_format($deposit) ?></span>
                                        </div>
                                        <div class="d-flex justify-content-between small fw-bold text-danger mt-1 pt-1 border-top border-light">
                                            <span>Còn nợ:</span>
                                            <span><?= number_format($remain) ?></span>
                                        </div>
                                    <?php endif; ?>

                                <?php else: ?>
                                    <span class="badge bg-danger bg-opacity-75 text-white">
                                        <i class="fas fa-exclamation-triangle me-1"></i>Chưa có giá
                                    </span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="text-end pe-4 text-nowrap">
                                ...
                                <?php if($remain <= 0 && $st != 'completed' && $st != 'cancelled' && $st != 'new'): ?>
                                     <a href="index.php?action=booking-status&id=<?= $bk['id'] ?>&status=completed" 
                                       class="btn btn-sm btn-success me-1 shadow-sm" title="Kết thúc tour">
            ...
            <div class="modal-content shadow-lg border-0">
                ...
                <div class="modal-body bg-light p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted mt-2 d-block fst-italic"><i class="fas fa-plus-circle me-1"></i> Số tiền này sẽ được cộng dồn vào khoản đã đóng trước đó.</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="payment_method" class="form-select">
                            ...
                            <option value="Cổng thanh toán">💳 Thẻ / VNPAY / Momo</option>
                        </select>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold small text-uppercase text-secondary">Ghi chú giao dịch</label>
                        <textarea name="payment_note" class="form-control" rows="2" placeholder="Mã giao dịch, nội dung chuyển khoản..."></textarea>
                    </div>
                </div>
