                    ...
                    <?php if (!empty($bookings)): ?>
                        ...
                        <tr class="<?= $isZeroPrice ? 'bg-danger bg-opacity-10' : '' ?>">
                            ...
                            <td>
                                ...
                                <div class="small text-truncate fw-bold mt-1" style="max-width: 180px;"><?= htmlspecialchars($bk['tour_name'] ?? '') ?></div>
                                ...
                                <?php if($total > 0): ?>
                                    ...
                                    <?php if($deposit > 0): ?>
                                        <div class="d-flex justify-content-between small text-success">
                                            <span>Đã thu:</span> <span><?= number_format($deposit) ?></span>
                                        </div>
                                        <?php if($remain > 0): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="text-success small border-top mt-1 pt-1 fw-bold text-end"><i class="fas fa-check-circle"></i> Đã thanh toán đủ</div>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php else: ?>
        ...
        <form action="index.php?action=booking-deposit" method="POST">
            ...
            <div class="modal-content shadow-lg border-0">
                ...
                <div class="modal-body bg-light p-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold small text-uppercase text-success">NHẬP SỐ TIỀN THANH TOÁN ĐỢT NÀY (VNĐ)</label>
                ...
                <div class="modal-footer bg-white border-0">
                    ...
                    <button type="submit" class="btn btn-warning px-4 fw-bold shadow-sm">Xác nhận Thanh Toán</button>
                </div>
            </div>
        </form>
    </div>
