                ...
                <tbody>
                    <?php if (!empty($customers)): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div><i class="fas fa-phone-alt text-secondary me-1"></i> <?= htmlspecialchars($cus['phone']) ?></div>
                                <div class="small text-muted"><i class="fas fa-envelope text-secondary me-1"></i> <?= htmlspecialchars($cus['email']) ?></div>
                            </td>
                            <td><span class="badge bg-info text-dark"><?= htmlspecialchars($cus['source']) ?></span></td>
                            <td class="text-muted small"><?= htmlspecialchars($cus['notes']) ?></td>
                            <td>
                                <a href="index.php?action=customer-detail&id=<?= $cus['id'] ?>" class="btn btn-sm btn-outline-info" title="Xem lịch sử">
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="5" class="text-center py-4">Chưa có khách hàng nào.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
